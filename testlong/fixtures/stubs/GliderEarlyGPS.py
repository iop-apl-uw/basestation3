#!/usr/bin/env python3
"""Stub stand-in for GliderEarlyGPS.py, used only by testlong's multipass validation
...
Accepts and ignores whatever real GliderEarlyGPS.py-style flags BaseRunnerMulti
