L.Control.Slider = L.Control.extend({
    ...
    _initLayout: function () {
        ...
        if (this.options.showValue){
            ...
            if (this.options.orientation =='vertical') {this._sliderContainer.style.height = (this.options.size.replace('px','') -36) +'px';}
...
*/
    ...
    _click: function() {
        if (this._container.classList.contains('leaflet-control-slider-expanded'))
            this._collapse();
        else
            this._expand();
    },
